  ...
  return (
    <>
      <Head>
        ...
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Prajwal Raut" />
        <meta
          name="description"
          content="Hi, I am Prajwal Raut, an adventurer in web development."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Prajwal Raut" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Prajwal Raut" />
        <meta
